...
SET "PROJECT_ROOT=C:\Users\wjdgn\Downloads\pk_system"

REM Change to the project root
cd /d "%PROJECT_ROOT%"

REM Construct full absolute paths
SET "F_UV_PYTHON_EXE=C:\Users\wjdgn\Downloads\pk_system\.venv\Scripts\python.exe" 
SET "F_PK_ENSURE_PK_WRAPPER_STARTED_PY=C:\Users\wjdgn\Downloads\pk_system\pk_internal_tools\pk_wrappers\pk_ensure_pk_wrapper_starter_executed.py"
