...
def ensure_general_ubuntu_pkg(ubuntu_pkg_n, **remote_device_target_config):
    ...
    tm = PkWirelessTargetController(identifier=PkDevice.undefined, setup_op=SetupOpsForPkWirelessTargetController.TARGET)
    std_outs, std_err_list = tm.ensure_command_to_wireless_target_with_pubkey(
    ...
    verify_outs, verify_errs = ensure_command_to_wireless_target_with_pubkey(
