...
def ensure_pk_interesting_infos_printed():
    ...
    # ensure_pk_interesting_infos_spoken(flags=PkModesForGetPkInterestingInfo.DATE | PkModesForGetPkInterestingInfo.TIME | PkModesForGetPkInterestingInfo.DAY_OF_WEEK)
