...
@ensure_seconds_measured
def ensure_remote_target_wifi_connected(
    ...
    try:
        ...
        logger.error("remote_target 연결 실패: %s", e, exc_info=True)
        return False
    ...
    if not wifi_password:
        ...
        env_var_id = get_pk_env_var_id("WIFI_PASSWORD", func_n)
    ...
    check_stdout, check_stderr, check_exit = controller.ensure_command_to_remote_target(
