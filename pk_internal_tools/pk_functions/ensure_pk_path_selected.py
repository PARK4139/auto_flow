...
def ensure_pk_root_selected(
    ...
    """
    # 1. 환경변수 확인 (최우선)
    pk_root_env = os.environ.get('PK_ROOT')
    if pk_root_env:
    ...
    try:
        ...
        pk_path_selection = ensure_env_var_completed_2025_11_24(
