from auto_flow_internal_tools.constants.pk_directories_for_pk_l_cam_pc import D_AUTO_FLOW_REPO
...
def ensure_routine_startup_enabled():
    ...
    if is_host_pk_renova():
        ...
        # ensure_pk_system_log_editable()
        # ensure_gemini_cli_interactive_mode_executed()
        ensure_windows_minimized()
        # ensure_pk_system_cli_executed_py_as_not_child_process()  # TODO : pk_system 을 백그라운드에서 단축키를 탐지하여 열도록 수정. 더 빨리 동작하게 하기 위함.
