...
def get_target_data_raw_from_target_request():
    ...
    request_template = {}
    request_template['target_device_type'] = ensure_value_completed(key_name="request_template['target_device_type']=",
                                                                    options=['xc', 'nx', 'no'])
    request_template['target_device_purpose'] = ensure_value_completed(key_name="request_template['target_device_purpose']=",
                                                                       options=['TODO_vehicle(undefined purpose)',
                                                                               'TODO_vehicle(undefined purpose)',
                                                                               'TODO_vehicle(For Internal TODO Development)'])
    request_template['target_device_aifw_version'] = ensure_value_completed(key_name="request_template['target_device_aifw_version']=",
                                                                            options=['1.2.1', '2.2.4.1', '2.2.4.1'])
    request_template['target_device_jetpack_version'] = ensure_value_completed(key_name="request_template['target_device_jetpack_version']=",
                                                                               options=['4.6.5', '5.0.2', '5.1.2'])
    request_template['target_device_jetson_setup_ver'] = ensure_value_completed(key_name="request_template['target_device_jetson_setup_ver']=",
                                                                                options=['', '2.0.1', '2.0.1'])
    request_template['target_device_side'] = ensure_value_completed(key_name="request_template['target_device_side']", options=['a', 'b'])
