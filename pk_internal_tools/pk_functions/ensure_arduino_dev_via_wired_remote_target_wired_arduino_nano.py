...
def _check_usb_serial_devices_on_remote_target(controller: PkRemoteTargetEngine) -> List[Dict[str, str]]:
...
def ensure_arduino_dev_via_wired_remote_target_wired_arduino_nano(
    ...
    try:
        ...
        devices = _check_usb_serial_devices_on_remote_target(controller)
