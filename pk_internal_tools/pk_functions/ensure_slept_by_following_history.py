...
from pk_internal_tools.pk_functions.ensure_following_history_reset_for_ensure_slept import get_env_var_id, ensure_following_history_reset_for_ensure_slept
...
def _measure_and_record_duration(
    ...
    ensure_spoken(get_easy_speakable_text(f"{elapsed_time:.2f}초 측정완료 "), wait=True)
    try:
