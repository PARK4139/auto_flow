...
def get_pk_interesting_info(
    ...
    Args:
        flags (SetupOpsForGetPkInterestingInfo): 포함할 정보 플래그.
    ...
    try:
        ...
        from pk_internal_tools.pk_functions.ensure_debug_loged_verbose import ensure_debug_loged_verbose # Added for new rule
        from pk_internal_tools.pk_functions.ensure_env_var_completed_2025_11_24 import ensure_env_var_completed_2025_11_24 # Added for ENV VAR
    ...
    if flags & SetupOpsForGetPkInterestingInfo.LOCATION_WEATHER:
        try:
            ...
            ensure_debug_loged_verbose(traceback) # Apply new rule
    ...
    if flags & SetupOpsForGetPkInterestingInfo.OS:
        try:
    ...
    if flags & SetupOpsForGetPkInterestingInfo.CONNECTED_DRIVES:
        try:
    ...
    if flags & SetupOpsForGetPkInterestingInfo.SCREEN:
        try:
    ...
    if flags & SetupOpsForGetPkInterestingInfo.PROJECT:
        try:
    ...
    if flags & SetupOpsForGetPkInterestingInfo.WINDOW_TITLES:
        try:
    ...
    if flags & SetupOpsForGetPkInterestingInfo.TASKLIST:
        try:
    ...
    if flags & SetupOpsForGetPkInterestingInfo.IMAGE_NAMES_INFO:
        try:
    ...
    if flags & SetupOpsForGetPkInterestingInfo.PROCESSES:
        try:
    ...
    if flags & SetupOpsForGetPkInterestingInfo.WIFI:
        try:
            ...
            # wifi_profile_name = ensure_value_completed_2025_10_13_0000(key_name="wifi_profile_name", func_n=func_n, options=wifi_profile_names)
    ...
    if flags & SetupOpsForGetPkInterestingInfo.QC_MODE:
        try:
