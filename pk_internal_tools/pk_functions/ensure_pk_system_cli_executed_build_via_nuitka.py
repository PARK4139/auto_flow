...
def ensure_pk_system_cli_executed_build_via_nuitka():
    """
    Automates the process of building the pk_ensure_pk_system_cli_executed.py
    ...
    target_script_relative = Path("pk_internal_tools/pk_wrappers/pk_ensure_pk_system_cli_executed.py")
...
if __name__ == "__main__":
    ensure_pk_system_cli_executed_build_via_nuitka()
