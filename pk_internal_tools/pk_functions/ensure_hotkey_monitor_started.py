...
from pk_internal_tools.pk_functions.ensure_pk_system_cli_executed import ensure_pk_system_cli_executed
import logging
...
class HotkeyMonitor:
    ...
    def _execute_pk_system(self):
        ...
        try:
            logging.debug(f"단축키 감지됨! pk_system 실행 중...")
