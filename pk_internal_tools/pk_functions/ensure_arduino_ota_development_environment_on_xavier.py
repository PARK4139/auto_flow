...
def ensure_arduino_ota_development_environment_on_xavier(
    ...
    try:
        ...
        # ESP8266 IP 주소 확인
        if not esp8266_ip:
            esp8266_ip_input = ensure_env_var_completed_2025_11_24(
                "ESP8266_IP",
                func_n=func_n,
        ...
        # ESP32 IP 주소 확인
        if not esp32_ip:
            esp32_ip_input = ensure_env_var_completed_2025_11_24(
                "ESP32_IP",
                func_n=func_n,
