...
def backup_workspace(D_PK_ARCHIVED, d_working, func_n):
    import traceback
    ...
    try:
        ...
        D_PK_ARCHIVED = Path(D_PK_ARCHIVED).resolve()
        ...
        logging.debug(f'''D_PK_ARCHIVED={D_PK_ARCHIVED} ''')
        os.makedirs(D_PK_ARCHIVED, exist_ok=True)
        ...
        archive_path = os.path.join(D_PK_ARCHIVED, archive_name)
