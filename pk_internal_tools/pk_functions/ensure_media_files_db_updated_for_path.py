...
from pk_internal_tools.pk_objects.pk_file_extensions import PK_FILE_EXTENSIONS # 확장자 목록 임포트
import traceback
...
def ensure_media_files_db_updated_for_path(target_directory: Path):
    ...
    # 미디어 파일 확장자 목록 가져오기
    media_extensions = PK_FILE_EXTENSIONS['videos'].union(PK_FILE_EXTENSIONS['audios'])
