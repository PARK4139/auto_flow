...
def move_window_to_front_via_window_title_seg(
    ...
    from pk_internal_tools.pk_functions.move_window_to_front_via_window_title_seg_via_pid import move_window_to_front_via_window_title_seg_via_pid
    ...
    while time.time() < end_deadline:
        ...
        if pid is not None:
            try:
                move_window_to_front_via_window_title_seg_via_pid(pid)
            except Exception as e_pid:
                logging.debug(f"move_window_to_front_via_window_title_seg_via_pid failed: {e_pid}")
