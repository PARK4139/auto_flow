...
def ensure_mouse_clicked_2025_11_11(x: int, y: int, button='left', clicks=1, interval=0.0, duration=0.0, restore_origin_location=False):
    """
...
@ensure_seconds_measured
def _ensure_mouse_clicked_safe(x: int, y: int, button='left', clicks=1, interval=0.0, duration=0.0):
    """
    ...
    try:
        ...
        return ensure_mouse_clicked_2025_11_11(x, y, button, clicks, interval, duration)
