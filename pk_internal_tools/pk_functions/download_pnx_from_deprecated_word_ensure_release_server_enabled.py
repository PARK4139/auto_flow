...
def download_pnx_from_deprecated_word_ensure_release_server_ran(remote_f_src, local_d_dst, **config_deprecated_word_ensure_release_server_ran):
    import paramiko
    import os

    user_n = config_deprecated_word_ensure_release_server_ran['user_n']
    ip = config_deprecated_word_ensure_release_server_ran['ip']
    pw = config_deprecated_word_ensure_release_server_ran['pw']
    port = config_deprecated_word_ensure_release_server_ran['port']
