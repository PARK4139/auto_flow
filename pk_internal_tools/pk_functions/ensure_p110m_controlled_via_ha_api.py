...
@ensure_seconds_measured
def ensure_p110m_controlled_via_ha_api(
        action: str,
        *,
    ...
    if not ha_url:
        ...
        if not ha_url:
            ...
            ha_url = ensure_env_var_completed_2025_11_24(
                key_name="HA_URL",
                func_n="ensure_p110m_controlled_via_ha_api",
    ...
    if not ha_token:
        ...
        env_var_id = get_env_var_id("HA_TOKEN", "ensure_p110m_controlled_via_ha_api")
    ...
    if not entity_exists:
        ...
        commission_code = ensure_env_var_completed_2025_11_24(
...
def get_ha_entity_state(
    ...
    if not ha_token:
        ha_token = ensure_env_var_completed_2025_11_24(
            key_name="HA_TOKEN",
            func_n="get_ha_entity_state",
