...
def get_gemini_cli_window_title_by_manual(gemini_cli_expected_titles= None):
    ...
    logging.debug(f"Calling ensure_value_completed_2025_10_13_0000 with key_name={key_name}, func_n={func_n}, options={gemini_cli_expected_titles}")
    selected = ensure_value_completed_2025_10_13_0000(key_name=key_name, func_n=func_n, options=gemini_cli_expected_titles, editable=False)
    logging.debug(f"ensure_value_completed_2025_10_13_0000 returned: {selected}")
