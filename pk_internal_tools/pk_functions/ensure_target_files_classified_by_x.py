...
def ensure_target_files_classified_by_x():
    try:
        ...
        org_mode = ensure_value_completed_2025_10_13_0000(key_name=org_mode_key, options=org_mode_options, func_n=func_n)
        ...
        if org_mode == '비디오 파일만':
            ...
            ext_input = ensure_value_completed_2025_10_13_0000(key_name='확장자 입력', guide_text='정리할 확장자를 입력하세요 (예: .txt)', func_n=func_n)
            if ext_input:
