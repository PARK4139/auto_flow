def ensure_target_filenames_and_file_content_texts_replaced(d_target, old_text, new_text, target_extensions, ignored_directory_names, operation_mode):
    import os
    ...
    for root, dirs, files in os.walk(d_target):
        for filename in files:
            ...
            ensure_target_filename_and_file_content_text_replaced(f_target=file_path_old, old_text=old_text, new_text=new_text, operation_mode=operation_mode)
