...
def ensure_pk_starting_routine_done_without_pk_log_file_logging(*, traced_file, traceback):
    ...
    ensure_pk_log_initialized(traced_file, with_file_logging_mode=False)
