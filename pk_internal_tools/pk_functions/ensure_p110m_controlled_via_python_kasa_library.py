...
@ensure_seconds_measured
def ensure_p110m_controlled_via_python_kasa_library(
    action: str,
    *,
...
""")
        ...
        remote_script_path = "/tmp/ensure_p110m_controlled_via_python_kasa_library.py"
...
def get_p110m_energy_data_via_tapo_local(
    *,
    ...
    """
    try:
        success = ensure_p110m_controlled_via_python_kasa_library(
            action="energy",
            host=host,
            username=username,
            password=password,
