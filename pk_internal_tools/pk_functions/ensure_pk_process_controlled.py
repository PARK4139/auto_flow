...
def ensure_pk_process_control():
    ...
    try:
        ...
        selected_display_name = ensure_value_completed(
            key_name="pk_process",
            func_n=func_n,
        ...
        selected_action = ensure_value_completed(
        ...
        if selected_action == "실행":
            ...
            # move_window_to_front_via_window_title_seg은 window_title_seg를 받음
...
def ensure_pk_process_controlled():
    """
    레거시 함수명 유지 (하위 호환성)
