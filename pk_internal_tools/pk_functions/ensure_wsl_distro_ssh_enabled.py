...
def ensure_wsl_distro_ssh_enabled():
    ...
    try:
        from pk_internal_tools.pk_functions.ensure_command_to_remote_os_with_pubkey import ensure_command_to_remote_target_with_pubkey
    except ImportError:
    ...
    for cmd in commands_to_execute:
        try:
            std_outs, std_err_list = ensure_command_to_remote_target_with_pubkey(cmd=cmd, **asdict(remote_device_target_config))
