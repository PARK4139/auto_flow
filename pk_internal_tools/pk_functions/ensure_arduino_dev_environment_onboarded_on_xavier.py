...
def ensure_arduino_dev_environment_onboarded_on_xavier(
...
"""
        ...
        add_user_group_cmd = f"sudo usermod -a -G dialout {xavier_user}"
        stdout, stderr, exit_code = controller.ensure_command_to_wireless_target(
...
"""
        ...
        logger.info("3. '%s@%s' 입력", xavier_user, xavier_ip)
