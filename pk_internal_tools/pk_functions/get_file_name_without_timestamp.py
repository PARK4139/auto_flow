...
def get_file_name_without_timestamp(timestamped_file_name: str, working_dir: str) -> Optional[str]:
    """
    타임스탬프가 포함된 파일명에서 타임스탬프를 제거하여 원본 파일명을 찾습니다.
    
    Args:
        timestamped_file_name: 타임스탬프가 포함된 파일명 (예: "file_20231121_143022.mkv")
    ...
    Example:
        >>> get_file_name_without_timestamp("video_20231121_143022.mkv", "/path/to/dir")
    ...
    # 타임스탬프 제거
    original_name = re.sub(timestamp_pattern, '', timestamped_file_name)
