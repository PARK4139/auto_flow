...
def ensure_p110m_pk_dashboard_server_started_on_xavier(
    host: str = "0.0.0.0",
    port: int = 8000,
    ...
    try:
        ...
        local_script_path = Path(__file__).parent / "ensure_p110m_pk_dashboard_server_on_xavier.py"
        ...
        remote_script_path = "/tmp/ensure_p110m_pk_dashboard_server_on_xavier.py"
