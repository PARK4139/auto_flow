...
def get_pk_root() -> Path:
    ...
    try:
        ...
        # __file__ 위치: pk_system/pk_internal_tools/pk_objects/pk_directories.py
        # 프로젝트 루트는 C:\Users\wjdgn\Downloads\pk_system
        # pk_system/src/pk_system/pk_internal_tools/pk_objects/pk_directories.py
        # 상위 5단계로 이동해야 src 폴더의 부모인 pk_system 루트가 됨
        ...
        # 만약 현재 프로젝트가 'pk_system/src/pk_system' 구조가 아니라
