...
def control_p110m_simple(action: str, entity_id: Optional[str] = None) -> bool:
    ...
    사용법:
        python ensure_p110m_controlled_via_ha_api_simple.py on
        python ensure_p110m_controlled_via_ha_api_simple.py off
        python ensure_p110m_controlled_via_ha_api_simple.py toggle
...
def main():
    """CLI 진입점"""
    if len(sys.argv) < 2:
        print("사용법: python ensure_p110m_controlled_via_ha_api_simple.py <action> [entity_id]")
