...
if __name__ == '__main__':
    from pk_internal_tools.pk_functions.ensure_routine_file_executed_as_hot_reloader import ensure_routine_file_executed_as_hot_reloader
    import traceback
    ...
    try:
        ensure_routine_file_executed_as_hot_reloader()
