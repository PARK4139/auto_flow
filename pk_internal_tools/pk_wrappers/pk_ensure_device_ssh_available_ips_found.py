if __name__ == "__main__":
    import traceback
    from pk_internal_tools.pk_functions.ensure_device_ssh_available_ips_found import ensure_device_ssh_available_ips_found
    ...
    try:
        ...
        ensure_device_ssh_available_ips_found()
        # test_ensure_device_ssh_available_ips_found()
