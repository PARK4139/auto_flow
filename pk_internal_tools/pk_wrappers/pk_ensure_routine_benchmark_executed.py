if __name__ == "__main__":
    import traceback
    from pk_internal_tools.pk_functions.ensure_routine_benchmark_executed import ensure_routine_benchmark_executed
    ...
    try:
        ...
        ensure_routine_benchmark_executed()
        # test_ensure_routine_benchmark_executed()
