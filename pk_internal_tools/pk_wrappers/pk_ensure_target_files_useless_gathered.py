from pk_internal_tools.pk_functions.ensure_target_files_useless_gathered import ensure_target_files_useless_gathered
...
if __name__ == "__main__":
    ...
    try:
        ...
        ensure_target_files_useless_gathered()
