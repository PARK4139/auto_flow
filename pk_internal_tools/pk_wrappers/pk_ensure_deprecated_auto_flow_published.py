if __name__ == "__main__":
    ...
    from pk_internal_tools.pk_objects.pk_directories import d_pk_root_sensitive, D_TASK_ORCHESTRATOR_CLI, d_pk_wrappers, d_pk_internal_tools, d_pk_external_tools, D_pk_FUNCTIONS, d_pk_external_tools, d_pk_external_tools, d_pk_tests, D_pk_OBJECTS, D_pk_wrappers, d_pk_info, d_pk_cache
    ...
    try:
        ...
        blacklist = [
            ...
            d_pk_wrappers / "pk_ensure_deprecated_auto_flow_published.py",
        ]
        ...
        if success:
            logging.debug("deprecated_auto_flow has been successfully prepared for publication.")
        else:
            logging.debug(f"{PkTexts.WARNING}Failed to publish deprecated_auto_flow.")
