...
def collect_magnet_set_from_nyaa_si(search_keyword=None, driver=None, via_f_txt=False, via_input=False):
    ...
    # answer = ensure_value_completed_2025_10_12_0000(key_name=f'can i open {get_nx(f)} (o/x)=', options=['o', 'x'])
    # if is_os_windows():
    #     if answer == 'o':
    ...
    search_keyword = ensure_value_completed_2025_10_12_0000(key_name='search_keyword', options=options)
    ...
    nyaa_si_supplier = ensure_value_completed_2025_10_12_0000(key_name='nyaa_si_supplier', options=['SubsPlease', '', 'Erai-raws'])
    ...
    positive_filter_keywords = ensure_value_completed_2025_10_12_0000(key_name='positive_filter_keywords', options=['1080'])
