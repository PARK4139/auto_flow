...
class PkP110mController:
    ...
    def __init__(
        self,
        wireless_target_controller: "PkWirelessTargetController",
        ha_url: Optional[str] = None,
        ha_token_env_name: str = "HA_TOKEN",
    ) -> None:
        self.target_controller = wireless_target_controller
        self._target = self.target_controller.wireless_target  # for convenience
...
"""
    ...
    def ensure_pk_p110m_controlled_on_target(
        ...
        script_filename = "ensure_pk_p110m_controlled_on_target.py"
        ...
        try:
            ...
            ok = self.target_controller.ensure_file_transferred_to_target(
                temp_script_path,
                remote_script_path,
            )
            if not ok:
        ...
        _, stderr, exit_status = self.target_controller.ensure_command_to_wireless_target(
            cmd=cmd,
            use_sudo=False,
        )
