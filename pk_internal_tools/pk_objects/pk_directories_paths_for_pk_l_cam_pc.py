...
from pk_internal_tools.pk_functions.is_host_pk_l_cam_pc import is_host_pk_l_cam_pc
...
if is_host_pk_l_cam_pc():
    ...
    D_SOURCE_PATH = D_PROJECT_ROOT_PATH / "auto_flow_internal_tools"
