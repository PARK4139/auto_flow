...
if __name__ == "__main__":
    try:
        ...
        from pk_internal_tools.pk_functions.ensure_pk_wrapper_starting_routine_done_without_pk_log_file_logging import ensure_pk_wrapper_starting_routine_done_without_pk_log_file_logging
        ...
        ensure_pk_wrapper_starting_routine_done_without_pk_log_file_logging(traced_file=__file__, traceback=traceback)
