...
D_PK_SYSTEM_PATH = D_PROJECT_ROOT_PATH / "assets" / "pk_system" # pk_system 서브모듈의 경로
D_PK_SYSTEM_SOURCES_PATH = D_PK_SYSTEM_PATH / "pk_system_sources" # pk_system 서브모듈 내 소스 디렉토리
