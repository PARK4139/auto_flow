...
# D_PK_SYSTEM_PATH and D_PK_SYSTEM_SOURCES_PATH are deprecated.
# pk_system is now installed as a library. Use get_pk_system_root() from temp.pk_system.pk_system_sources instead.
